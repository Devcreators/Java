...
public class Sample07 {
	...
	public static void main(String[] args) {
		...
		if (retCity == null) {
			...
			switch(retCity) {
			case SEOUL -> System.out.printf("\n%s(으)로 출발합니다.", CITY.SEOUL.getDestination());
			case DAEJEON -> System.out.printf("\n%s(으)로 출발합니다.", CITY.DAEJEON.getDestination());
			case DAEGU -> System.out.printf("\n%s(으)로 출발합니다.", CITY.DAEGU.getDestination());
			case PUSAN -> System.out.printf("\n%s(으)로 출발합니다.", CITY.PUSAN.getDestination());
			case GWANGJU -> System.out.printf("\n%s(으)로 출발합니다.", CITY.GWANGJU.getDestination());
