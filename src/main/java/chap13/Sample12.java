...
public class Sample12 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("2020년 %s입니다.\n", (date1.isLeapYear() ? "윤년" : "평년"));
		System.out.printf("1945년 %s입니다.\n", (date2.isLeapYear() ? "윤년" : "평년"));
		...
		System.out.println();
		System.out.printf("1년 전 날짜는 %s\n", date1.minusYears(1));
		System.out.printf("6개월 전 날짜는 %s\n", date1.minusYears(6));
		System.out.printf("3일 전 날짜는 %s\n", date1.minusDays(3));
		System.out.printf("3주 전 날짜는 %s\n", date1.minusWeeks(3));
		
		System.out.println();
		System.out.printf("1년 후 날짜는 %s\n", date1.plusYears(1));
		System.out.printf("6개월 후 날짜는 %s\n", date1.plusYears(6));
		System.out.printf("3일 후 날짜는 %s\n", date1.plusDays(3));
		System.out.printf("3주 후 날짜는 %s\n", date1.plusWeeks(3));
	}
