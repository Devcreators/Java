...
public class Sample17 {
	...
	public static void main(String[] args) {
		...
		System.out.println("ISO_LOCAL_DATE_TIME - " + DateTimeFormatter.ISO_LOCAL_DATE.format(LocalDateTime.of(2020, 5, 5, 10, 5, 12)));
		System.out.println("ISO_TIME - " + DateTimeFormatter.ISO_TIME.format(LocalDateTime.of(2020, 5, 5, 10, 5, 12)));
	}
}
