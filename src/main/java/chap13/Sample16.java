...
public class Sample16 {
	...
	public static void main(String[] args) {
		...
		ZoneId bangkoklZone = ZoneId.of("Asia/Bangkok");
		ZoneId sydneyZone 	= ZoneId.of("Australia/Sydney");

		LocalDateTime ldt2 = LocalDateTime.now(seoulZone);
		System.out.println("\n1. LocalDateTime 서울 : " + ldt2);
		LocalDateTime ldt3 = LocalDateTime.now(bangkoklZone);
		...
		ZonedDateTime zdt2 = ZonedDateTime.now(bangkoklZone);
		...
		ZonedDateTime nationalLiberationDay = Year.of(1945).atMonth(8).atDay(15).atTime(10, 30).atZone(ZoneId.of("Asia/Seoul"));
